...
class AdapterListWisataAlam (private val onItemClickListener: OnItemClickListener) :
    ListAdapter<DataItemAlam, AdapterListWisataAlam.ViewHolder>(DiffCallback()) {
    ...
    interface OnItemClickListener {
        fun onItemClick(place: DataItemAlam)
    }

    private class DiffCallback : DiffUtil.ItemCallback<DataItemAlam>() {
        override fun areItemsTheSame(oldItem: DataItemAlam, newItem: DataItemAlam): Boolean {
            return oldItem.name == newItem.name
        }

        override fun areContentsTheSame(oldItem: DataItemAlam, newItem: DataItemAlam): Boolean {
