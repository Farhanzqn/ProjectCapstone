...
class AdapterListWisataReligi (private val onItemClickListener: OnItemClickListener) :
    ListAdapter<DataItemReligi, AdapterListWisataReligi.ViewHolder>(DiffCallback()) {
    ...
    interface OnItemClickListener {
        fun onItemClick(place: DataItemReligi)
    }

    private class DiffCallback : DiffUtil.ItemCallback<DataItemReligi>() {
        override fun areItemsTheSame(oldItem: DataItemReligi, newItem: DataItemReligi): Boolean {
            return oldItem.name == newItem.name
        }

        override fun areContentsTheSame(oldItem: DataItemReligi, newItem: DataItemReligi): Boolean {
